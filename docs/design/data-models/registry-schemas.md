...
| `path` | `string` | `true` | `pattern=^(?!/)(?!.*(?:^|/)\.\.(?:/|$))[A-Za-z0-9._/-]+$` | repo-relative agent workspace path |
...
| `path` | `string` | `true` | `pattern=^(?!/)(?!.*(?:^|/)\.\.(?:/|$))[A-Za-z0-9._/-]+$` | repo-relative SKILL.md path |
...
| `openclaw.source` | `string` | `true` | `pattern=^(?!/)(?!.*(?:^|/)\.\.(?:/|$))[A-Za-z0-9._/-]+$` | OpenClaw source path |
...
| `openclaw.bundle_source` | `string` | `false` | `pattern=^(?!/)(?!.*(?:^|/)\.\.(?:/|$))[A-Za-z0-9._/-]+$` | bundle source when projection_mode=bundle |
| `openclaw.allow_draft_projection` | `boolean` | `false` | `` | allow draft assets in runtime projection |
| `tests` | `object` | `true` | `` | test references |
| `tests.test_doc` | `string` | `true` | `pattern=^(?!/)(?!.*(?:^|/)\.\.(?:/|$))[A-Za-z0-9._/-]+$` | skill test doc path |
| `tests.methodology_ref` | `string` | `true` | `pattern=^(?!/)(?!.*(?:^|/)\.\.(?:/|$))[A-Za-z0-9._/-]+$` | test methodology reference |
...
| `skill_path` | `string` | `true` | `pattern=^(?!/)(?!.*(?:^|/)\.\.(?:/|$))[A-Za-z0-9._/-]+$` | repo-relative process SKILL.md path |
| `manifest_path` | `string` | `true` | `pattern=^(?!/)(?!.*(?:^|/)\.\.(?:/|$))[A-Za-z0-9._/-]+$` | repo-relative process manifest path |
