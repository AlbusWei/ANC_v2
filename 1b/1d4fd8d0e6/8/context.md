...
以QA身份对M6模块进行补测，完善测试计划/用例并修复问题直到回归通过

### Prompt 45

基于用户已配置可用的全局LLM judge，对M6做LLM as judge重测并修复

### Prompt 46

基于LLM as judge重测M6并修复测试设计问题
...
提交review-layers-modules改动并执行worktree同步推送

### Prompt 49

提交后执行review-layers-modules到rebuild同步并扇出推送

### Prompt 50

设计并验证 OpenClaw 工作区从 ANC 迁移到 ANC_v2，并支持 worktree 切换

### Prompt 51

实现 OpenClaw 工作区迁移与 worktree 切换脚本并完成运行验证

### Prompt 52

修复 OpenClaw invalid config 并保证 worktree 切换时 skills 可加载

### Prompt 53

同步 OpenClaw workspace 切换规范到 rebuild 并扇出到各 worktree 分支

### Prompt 54

将 workspace 切换变更从 rebuild 扇出到 review worktrees 并补齐提交门禁

### Prompt 55

合并layers-modules到rebuild，并根据当前施工状态更新AGENTS.md的阶段边界与协作原则

### Prompt 56

将rebuild的新内容回灌到codex/review-agents并推送远端

### Prompt 57

将rebuild的新内容回灌到codex/review-integration并推送远端

### Prompt 58

将rebuild的新内容回灌到codex/review-layers-modules并推送远端

### Prompt 59

将rebuild的新内容回灌到codex/review-processes-business并推送远端

### Prompt 60

将rebuild的新内容回灌到codex/review-skills并推送远端
