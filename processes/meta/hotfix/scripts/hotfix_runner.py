...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--evidence-dir",
        default="",
        help="Evidence directory path (repo-relative). Default docs/design/modules/evidence/bpm-runtime/w3d_hotfix_refactor_cases/<run_id>/hotfix/execution",
    )
...
def main() -> int:
    ...
    evidence_dir = resolve_path(
        root,
        args.evidence_dir.strip() or f"docs/design/modules/evidence/bpm-runtime/w3d_hotfix_refactor_cases/{run_id}/hotfix/execution",
    )
